...
module Commands::Install::Linker
  ...
  abstract class Base
    ...
    getter main_package : Data::Package
    getter installed_packages_with_hooks = [] of {Data::Package, Path}
    ...
    def remove(dependencies : Set({String, String | Data::Package::Alias, String})) : Nil
    ...
    protected def unlink_binaries(package : Data::Package, package_path : Path)
      if bin = package.bin
        if bin.is_a?(Hash)
    ...
    protected def resolve_peers(package : Data::Package, ancestors : Ancestors) : Set(Data::Package)?
      ...
      if peers.size > 0
        ...
        Set(Data::Package).new.tap do |resolved_peers|
    ...
    protected def resolve_transitive_overrides(package : Data::Package, ancestors : Ancestors) : Set(Data::Package::Overrides::Parent)?
      result = Set(Data::Package::Overrides::Parent).new

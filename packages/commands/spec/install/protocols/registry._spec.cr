require "../spec_helper"
require "../../../install/protocol/registry"

module Commands::Install::Protocol::Registry::Spec
  describe Protocol::Registry, tags: "protocol" do
...

    {
      ...
      {"package", "1.0.0", Semver.parse("1.0.0")},
      {"@scope/package", "1.0.0", Semver.parse("1.0.0")},
      {"package", "^2", Semver.parse("^2")},

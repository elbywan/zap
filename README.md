...
| Scenario | npm v11.19.0 | yarn v4.18.0 | zpm v6.0.0-rc.20 | pnpm v12.4.1 | bun v1.4.2 | zap v0.9.1 |
| --- | --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 34.0 s | 9.3 s | 3.6 s | 3.4 s | **2.7 s** | 4.0 s |
| Without lockfile or node modules | 14.0 s | 6.1 s | 1.7 s | 1.0 s | **656 ms** | 1.1 s |
| Without lockfile | 1.6 s | 8.1 s | 1.7 s | 589 ms | **77 ms** | 581 ms |
| Without node modules | 7.3 s | 4.4 s | **600 ms** | 898 ms | 613 ms | 678 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34768483460).

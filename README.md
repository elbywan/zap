...
| Scenario | npm v11.19.0 | yarn v4.18.0 | pnpm v11.24.0 | bun v1.4.0 | zap v0.9.1 |
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 37.6 s | 11.0 s | 8.7 s | **2.5 s** | 4.2 s |
| Without lockfile or node modules | 16.0 s | 7.0 s | 6.7 s | **391 ms** | 833 ms |
| Without lockfile | 1.5 s | 3.7 s | 600 ms | **74 ms** | 408 ms |
| Without node modules | 8.4 s | 5.0 s | 2.3 s | **332 ms** | 657 ms |

Median of 3 runs after 1 warmup, measured on 2026-08-31.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/33366815804).

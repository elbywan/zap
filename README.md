...
| Scenario | npm v11.19.0 | yarn v4.18.0 | zpm v6.0.0-rc.20 | pnpm v12.4.1 | bun v1.4.2 | zap v0.10.1 |
| --- | --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 33.6 s | 9.0 s | 4.5 s | 3.4 s | **2.8 s** | 3.8 s |
| Without lockfile or node modules | 13.7 s | 6.0 s | 1.7 s | 1.0 s | **657 ms** | 1.1 s |
| Without lockfile | 1.6 s | 8.4 s | 1.8 s | 587 ms | **76 ms** | 602 ms |
| Without node modules | 7.4 s | 4.4 s | **596 ms** | 814 ms | 612 ms | 693 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34775972297).

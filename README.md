...
| Scenario | npm v11.19.0 | yarn v4.18.0 | zpm v6.0.0-rc.20 | pnpm v12.4.1 | bun v1.4.2 | zap v0.10.0 |
| --- | --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 33.5 s | 12.1 s | 3.8 s | 3.3 s | **2.5 s** | 4.1 s |
| Without lockfile or node modules | 18.7 s | 8.2 s | 1.6 s | 998 ms | **726 ms** | 1.1 s |
| Without lockfile | 2.3 s | 11.5 s | 1.4 s | 714 ms | **90 ms** | 669 ms |
| Without node modules | 11.1 s | 6.1 s | 719 ms | 731 ms | **658 ms** | 709 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34773895116).

...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 35.7 s | 9.3 s | 7.8 s | **3.3 s** | 4.3 s |
| Without lockfile or node modules | 13.0 s | 6.0 s | 7.5 s | **413 ms** | 761 ms |
| Without lockfile | 1.0 s | 2.7 s | 460 ms | **63 ms** | 333 ms |
| Without node modules | 6.6 s | 4.1 s | 3.4 s | **339 ms** | 600 ms |

Median of 3 runs after 1 warmup, measured on 2026-08-31.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/33361415518).

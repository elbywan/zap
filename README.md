...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 35.0 s | 12.2 s | 9.8 s | **2.5 s** | 6.2 s |
| Without lockfile or node modules | 18.5 s | 8.2 s | 7.3 s | **712 ms** | 2.4 s |
| Without lockfile | 1.7 s | 3.7 s | 661 ms | **88 ms** | 450 ms |
| Without node modules | 10.9 s | 6.5 s | 3.0 s | **673 ms** | 2.3 s |

Median of 3 runs after 1 warmup, measured on 2026-08-30.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/33340243293).

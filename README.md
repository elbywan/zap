...
| Scenario | npm v11.19.0 | yarn v4.18.0 | pnpm v11.24.0 | bun v1.4.0 | zap v0.9.0 |
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 29.7 s | 10.9 s | 9.3 s | **2.4 s** | 4.9 s |
| Without lockfile or node modules | 16.7 s | 7.3 s | 6.9 s | **755 ms** | 1.1 s |
| Without lockfile | 1.5 s | 3.5 s | 620 ms | **97 ms** | 462 ms |
| Without node modules | 9.1 s | 5.3 s | 2.6 s | **686 ms** | 943 ms |

Median of 3 runs after 1 warmup, measured on 2026-08-31.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/33363092468).

...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 34.7 s | 10.8 s | 3.2 s | **2.7 s** | 5.2 s |
| Without lockfile or node modules | 16.2 s | 7.2 s | 1.1 s | **728 ms** | 1.1 s |
| Without lockfile | 1.9 s | 9.6 s | 690 ms | **97 ms** | 490 ms |
| Without node modules | 9.0 s | 5.2 s | 706 ms | **677 ms** | 919 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-12.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34707666887).

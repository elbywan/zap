...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 25.2 s | 8.7 s | 3.0 s | **2.4 s** | 3.9 s |
| Without lockfile or node modules | 12.9 s | 5.7 s | 1.0 s | **709 ms** | 806 ms |
| Without lockfile | 1.6 s | 7.6 s | 538 ms | **76 ms** | 355 ms |
| Without node modules | 7.0 s | 4.1 s | 823 ms | 668 ms | **667 ms** |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34756500457).

...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 26.5 s | 8.7 s | 2.9 s | **2.1 s** | 4.2 s |
| Without lockfile or node modules | 13.6 s | 5.8 s | 1.1 s | **648 ms** | 925 ms |
| Without lockfile | 1.6 s | 7.7 s | 592 ms | **76 ms** | 370 ms |
| Without node modules | 7.1 s | 4.2 s | 1.6 s | 1.1 s | **803 ms** |

Median of 3 runs after 1 warmup, measured on 2026-09-12.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34681198103).

...
| Scenario | npm v11.19.0 | yarn v4.18.0 | pnpm v12.4.1 | bun v1.4.2 | zap v0.9.1 |
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 32.1 s | 12.0 s | 3.1 s | **2.5 s** | 4.0 s |
| Without lockfile or node modules | 18.9 s | 8.3 s | 1.1 s | **720 ms** | 893 ms |
| Without lockfile | 2.3 s | 11.3 s | 733 ms | **92 ms** | 464 ms |
| Without node modules | 11.2 s | 6.3 s | 755 ms | **676 ms** | 744 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34759712275).

...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 40.4 s | 10.3 s | 8.8 s | **2.9 s** | 7.1 s |
| Without lockfile or node modules | 15.5 s | 6.8 s | 5.9 s | **436 ms** | 1.0 s |
| Without lockfile | 1.3 s | 3.3 s | 543 ms | **73 ms** | 432 ms |
| Without node modules | 7.4 s | 4.7 s | 2.5 s | **381 ms** | 712 ms |

Median of 3 runs after 1 warmup, measured on 2026-08-30.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/33311981417).

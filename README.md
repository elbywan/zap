...
| --- | --- | --- | --- | --- | --- |
| Without cache, lockfile or node modules | 32.0 s | 11.8 s | 3.2 s | **2.6 s** | 4.0 s |
| Without lockfile or node modules | 18.9 s | 8.0 s | 1.0 s | **705 ms** | 1.1 s |
| Without lockfile | 2.2 s | 10.8 s | 674 ms | **87 ms** | 630 ms |
| Without node modules | 10.8 s | 6.0 s | 681 ms | **654 ms** | 701 ms |

Median of 3 runs after 1 warmup, measured on 2026-09-13.
Results generated by [this workflow run](https://github.com/elbywan/zap/actions/runs/34766465584).

...
module Zap::Commands::Install::Protocol::Alias::Spec
  describe Protocol::Alias, tags: "protocol" do
...

    {
      ...
      {"npm:jquery@2", "jquery2", Aliased.new(name: "jquery", alias: "jquery2"), Utils::Semver.parse("2")},
      {"alias:jquery@^2", "jquery2", Aliased.new(name: "jquery", alias: "jquery2"), Utils::Semver.parse("^2")},
